...
function Content({ headers, user, conversations, setConversations }) {
  ...
  const infoConversation = conversations.find(
    (conversation) => conversation.link === `${room.roomId}/${room.userId}`
  )
          ...
          <div className={cx('user')}>
            ...
            <div className={cx('info')}>
              <span className={cx('name')}>
                {infoConversation.name} {console.log(typing)}
              </span>
